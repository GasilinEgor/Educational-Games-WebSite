...
function tap(event) {
    if (counter % 2 == 0){
        event.target.innerHTML =  '<img src="https://i.ibb.co/k41mvC9/close.png" alt="close" border="0" width=22>';
    }
    else{
        event.target.innerHTML = '<img src="https://i.ibb.co/k6Xtv6N/circle.png" alt="circle" border="0" width=22>';
    }
    if (isVictory()) {
